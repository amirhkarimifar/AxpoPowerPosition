...
public static class DashboardLauncher
{
    ...
    public static Process? TryStart(string workerContentRoot, ILogger logger)
    {
        ...
        try
        {
            ...
            logger.LogInformation("Dashboard starting at {DashboardUrl} — open it in your browser", DashboardUrl);
            PrintBanner();
            return process;
        }
